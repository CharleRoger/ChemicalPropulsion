...
- [Chemical Core (1.4.2)](https://github.com/CharleRoger/ChemicalCore)
- [Ignition (1.2.2)](https://github.com/CharleRoger/Ignition)
- [Space Dust Next (3.1.0)](https://github.com/NerdyBoy709/SpaceDustNext) (only if using [Space Dust](https://github.com/post-kerbin-mining-corporation/SpaceDust))
